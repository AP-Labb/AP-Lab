...
export function UniversalTopHeader() {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 w-full backdrop-blur-2xl bg-[#080911]/95 border-b border-white/[0.08] px-4 sm:px-8 py-3 flex items-center justify-between font-manrope">
