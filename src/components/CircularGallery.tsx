...
function createTextTexture(gl: any, text: string, font = 'bold 30px monospace', color = 'black') {
  ...
  if (!context) return { texture: new Texture(gl), width: 100, height: 50 };
  context.font = font;
...
class App {
  ...
  createMedias(items: any, bend = 1, textColor: string, borderRadius: number, font: string) {
    const defaultItems = [
      { image: `https://picsum.photos/seed/1/800/600?grayscale`, text: 'Scholars' },
      { image: `https://picsum.photos/seed/2/800/600?grayscale`, text: 'Pass Rate' }
    ];
