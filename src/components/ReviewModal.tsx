          ...
          >
            ...
            <div className="p-8">
              {isSubmitted ? (
                ...
                >
                  <CheckCircle className="w-12 h-12 text-[#1db954] mb-4" />
                  <h3 className="text-xl font-bold text-white mb-2">Review Submitted</h3>
                  <p className="text-neutral-400 text-sm font-medium">Thank you for helping us improve AP Lab.</p>
                </motion.div>
              ) : (
                <>
                  <h2 className="text-2xl font-bold text-white mb-1.5 tracking-tight font-manrope">Write a Review</h2>
                  <p className="text-neutral-400 text-sm mb-6 font-manrope">Share your learning experience with the community.</p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex flex-col items-center py-4 bg-neutral-950 rounded-xl border border-white/5">
                      ...
                      <div className="flex items-center space-x-1.5">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <button
                            ...
                            className="p-0.5 transition-transform hover:scale-105 active:scale-95 focus:outline-none"
                          >
                            <Star
                              className={cn(
                      ...
                      <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest mt-2 font-mono">
                    ...
                    <div className="space-y-4">
                      <div>
                        <label htmlFor="title" className="block text-[10px] font-bold text-neutral-400 uppercase tracking-wider mb-2 font-mono">Title</label>
                        <input
                          id="title"
                          type="text"
                          value={title}
                      ...
                      <div>
                        <label htmlFor="description" className="block text-[10px] font-bold text-neutral-400 uppercase tracking-wider mb-2 font-mono">Review</label>
                        <textarea
                          id="description"
                          value={description}
                    ...
                    <button
                      type="submit"
                      disabled={rating === 0 || !title || !description}
                      className="w-full py-3.5 rounded-full bg-white text-black font-bold text-sm hover:bg-neutral-200 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-white font-manrope"
                    >
                      Submit Review
                    </button>
