  ...
  return (
    <div className="min-h-screen bg-[#030408] text-white flex flex-row relative z-0 overflow-x-clip transition-all duration-500 selection:bg-neutral-800 selection:text-white font-manrope">
      ...
      <div className="flex-1 flex flex-col min-h-screen md:pl-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <UserDisplayName 
                  name={currentUser.displayName || progress?.displayName || "Scholar"} 
                  activeNameColor={progress?.activeNameColor} 
                  className="text-lg font-extrabold font-manrope" 
                />
          ...
          >
            <div className="space-y-6">
              ...
              <div className={`flex flex-col items-center py-4 rounded-xl border relative overflow-hidden w-full transition-all duration-300 ${streakStyle.borderColor} ${streakStyle.bgClass}`}>
                ...
                <div className="flex items-center justify-center w-28 h-28 mb-2">
                  <StreakFlameIcon streakCount={streakCount} sizeClassName="w-24 h-24" />
                </div>
        ...
        {/* XP & COIN DAILY EARNINGS DUAL-LINE GRAPH */}
        <motion.div 
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.3 }}
          className="bg-neutral-950/80 rounded-2xl border border-white/5 p-6 flex flex-col space-y-6 shadow-md relative"
        >
        ...
        {/* SUBJECT STUDY TIME DISTRIBUTION PIE CHART */}
        <motion.div 
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/40">Percentage of study time spent on your opened AP subjects</p>
            </div>
          </div>
