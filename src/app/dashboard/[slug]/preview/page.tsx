...
export default function CoursePreviewPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#070913] text-white flex flex-row relative z-0 overflow-x-hidden font-manrope">
      ...
      <div className="flex-1 flex flex-col min-h-screen md:pl-16 max-w-6xl mx-auto w-full px-4 sm:px-8 py-8 space-y-8 pb-20 text-left">
        ...
        <div className="space-y-6">
          ...
          <div className="pt-4 flex justify-end">
            <Link
              href={`/dashboard/${slug}`}
              className="flex items-center space-x-2.5 px-8 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-manrope font-extrabold text-sm transition-all cursor-pointer shadow-xl hover:scale-105"
            >
              <Play className="w-4 h-4 fill-white" />
              <span>Start Course</span>
            </Link>
